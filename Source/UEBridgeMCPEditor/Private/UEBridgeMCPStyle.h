...
namespace UEBridgeMCP
{
	...
	static FString GetClaudeCliInstallUrl()
	{
		return TEXT("https://docs.claude.com/en/docs/claude-code/setup");
	}

	// Official ACP adapter that lets the in-panel chat drive Claude Code over ACP.
	static FString GetClaudeAcpAdapterUrl()
	{
		return TEXT("https://www.npmjs.com/package/@agentclientprotocol/claude-agent-acp");
	}
